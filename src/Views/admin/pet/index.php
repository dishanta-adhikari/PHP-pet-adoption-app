...
<head>
    ...
    <link rel="stylesheet" href="<?= $appUrl ?>/public/assets/css/view_all_pets.css">
</head>

<body class="bg-light">
    <div class="container mt-4 mt-md-5">
        <h3>All Pets in System</h3>
        <a href="<?= $appUrl ?>/src/Views/admin/dashboard" class="btn btn-secondary mb-3">Back to Dashboard</a>
